...
export const Login = ({ isOpen, onClose}) => {
 ...
 const handleClick = () => {
  ...
  return (
    ...
    <button onClick={handleClick} class="px-4 py-2 border flex gap-2 border-slate-200 dark:border-slate-700 rounded-lg text-slate-700 dark:text-slate-200 hover:border-slate-400 dark:hover:border-slate-500 hover:text-slate-900 dark:hover:text-slate-300 hover:shadow transition duration-150">
